        ...
        <>
            ...
            >
                ...
                <DialogContent>
                 ...
                 <div style={{ marginBottom: '10px' , width: '500px' }}>
                 <TextField id="outlined-basic" label={t('Offer Name')} variant="outlined"sx={{ width: '100%' }}/>
                 </div>
                 <div style={{ marginBottom: '10px' , width: '500px' }}>
                 <TextField id="outlined-basic" label={t('Offer Duration')} variant="outlined"sx={{ width: '100%' }}/>
                 </div>
