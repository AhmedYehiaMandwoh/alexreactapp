...
const initialRows = [
  { id: 1,  countryName: 'Jon' },
  { id: 2, countryName: 'Lannister' },
  { id: 3, countryName: 'Lannister' },
  { id: 4, countryName: 'Stark' },
  { id: 5, countryName: 'Targaryen' },
  { id: 6, countryName: 'Melisandre'},
  { id: 7, countryName: 'Clifford' },
  { id: 8, countryName: 'Frances' },
  { id: 9, countryName: 'Roxie'},
];
    ...
    <MainCard>
      <Box sx={{ width: '100%' }}>
        <Grid container rowSpacing={1} justifyContent="space-between" alignItems="center">
          <Grid>
            <Item>
              <h2 className="main_title_table">{t('Banned Countries')}</h2>
            </Item>
          </Grid>
          <Grid >
            <Item>
