...
const columns = [
  ...
  { field: 'ban', headerName: 'Ban', width: 130 },
  { field: 'temporaryBan', headerName: 'temporary Ban', width: 130 },
  { field: 'temporaryBan', headerName: 'temporary Ban', width: 130 },
...
const initialRows = [
  { id: 1, ban: 'Snow', temporaryBan: 'Jon'},
  { id: 2, ban: 'Snow', temporaryBan: 'Jon'},
  { id: 3, ban: 'Snow', temporaryBan: 'Jon'},
  { id: 4, ban: 'Snow', temporaryBan: 'Jon'},
  { id: 5, ban: 'Snow', temporaryBan: 'Jon'},
  { id: 6, ban: 'Snow', temporaryBan: 'Jon'},
];
    ...
    <MainCard>
      <Box sx={{ width: '100%' }}>
        <Grid container rowSpacing={1} justifyContent="space-between" alignItems="center">
          <Grid>
            <Item>
              <h2 className="main_title_table">{t('Supervisor')}</h2>
            </Item>
          </Grid>
          <Grid >
